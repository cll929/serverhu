...
// 环境变量
const UUID = process.env.UUID || '8f9a2bb7-bf0c-4a94-9c01-3be8a94f6c10'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || 'xyu8800-ppp.hf.space';                   // 域名或ip,留空将自动获取服务器ip
